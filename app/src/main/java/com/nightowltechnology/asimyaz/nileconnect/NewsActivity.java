...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeView = (SwipeRefreshLayout)findViewById(R.id.swipe_news);
        web = (WebView) findViewById(R.id.webview_news);
        ...
        if(isNetworkConnected()) {
            web.loadUrl("http://nileuniversity.edu.ng/category/nile-news/");
