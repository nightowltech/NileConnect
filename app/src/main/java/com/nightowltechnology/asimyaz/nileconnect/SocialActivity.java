...
public class SocialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeView = (SwipeRefreshLayout)findViewById(R.id.swipe_social);
        web = (WebView) findViewById(R.id.webview_social);
        ...
        web.setWebViewClient(new SocialActivity.myWebClient());
        web.getSettings().setJavaScriptEnabled(true);
        web.getSettings().setCacheMode(WebSettings.LOAD_DEFAULT);
        if(isNetworkConnected()) {
            web.loadUrl("http://nightowl.com.ng/nileconnect_news.html");
