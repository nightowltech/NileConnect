...
public class SRCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeView = (SwipeRefreshLayout)findViewById(R.id.swipe_src);
        web = (WebView) findViewById(R.id.webview_src);
        ...
        if(isNetworkConnected()) {
            web.loadUrl("http://www.nilesrc.blogspot.com.ng");

        }
        else{
            web.setVisibility(View.GONE);
            AlertDialog.Builder builder = new AlertDialog.Builder(SRCActivity.this);
            builder.setMessage("Sorry your network is not connected.");
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent i = new Intent(SRCActivity.this,MainActivity.class);
                    startActivity(i);
